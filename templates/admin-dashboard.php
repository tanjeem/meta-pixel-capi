					...
					<div class="mpc-table-wrap">
						<table class="mpc-table">
							...
							<tbody id="mpc-log-body">
								...
								if ( empty($logs) ) : ?>
									<tr><td colspan="5" style="text-align:center; color: var(--mpc-text-dim); padding: 30px;">No events logged yet. Events will appear here once your Pixel ID and CAPI Token are configured.</td></tr>
								<?php else :
									foreach ( $logs as $log ) :
								...
								<tr>
									...
									<td style="font-size:.75rem; color: var(--mpc-text-dim); word-break: break-all;"><?php echo esc_html( substr($log->event_id, 0, 20) ); ?>…</td>
									<td>
